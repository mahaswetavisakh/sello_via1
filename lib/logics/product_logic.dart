...
class ProductLogic extends GetxController{
 ...
 Future createProduct({String? productName,String? price,String? description, String? category,String? subCategory,List<XFile>? images}) async {
   ...
   List<String> imgUrls=[];
    if(productName!.isEmpty){
      ...
      DocumentReference documentReference=  await _db.collection("products").add(product.toMap());

      await _db.collection("products").doc(documentReference.id).update({
